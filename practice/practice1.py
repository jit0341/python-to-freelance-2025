...
def load_inventories():
    ...
    try:
        ...
        print(f"An error occured during loading inventories.")
        inventories = {}
    ...
    try:
        with open("inventories.txt","w") as file:
            for product_name,details in inventories.items():
                ...
                file.write(line)
        print(f"\nInventories saved successfully into inventories.txt")
    except Exception as e:
        print(f"Error saving inventories.")
...
def add_inventories():
    ...
    if product_name in inventories:
        print(f"Inventories '{product_name}' already exists!")
        return
